...
export const CATEGORY_IMAGES: Record<PaymentCategory, string> = {
  ...
  utilities: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=300&h=200&fit=crop", 
  furniture: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=300&h=200&fit=crop",
  daily: "https://images.unsplash.com/photo-1542838132-92c53300491e?w=300&h=200&fit=crop",
  other: "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=300&h=200&fit=crop",
};
...
export const BOT_MESSAGES = {
  ...
  FLOW_ERROR: "❌ 現在の操作を完了するか、「入力を始める」と入力して最初からやり直してください。",
  INVALID_OPERATION: "❌ 不正な操作です。「入力を始める」と入力して最初からやり直してください。",
  OPERATION_CANCELLED: "❌ 操作をキャンセルしました。\n\n💡 再度開始するには「入力を始める」と入力してください。",
  SESSION_CANCELLED: "❌ セッションを終了しました。\n\n💡 新しく開始するには「入力を始める」と入力してください。",
  REGISTRATION_CANCELLED: "❌ 登録をキャンセルしました。\n\n💡 再度登録するには「入力を始める」と入力してください。",
  SAVE_ERROR: "❌ 登録中にエラーが発生しました。もう一度お試しください。\n\n💡 「入力を始める」と入力して最初からやり直してください。",
  START_HINT: "💡 支払い情報を入力するには「入力を始める」と入力してください。",
  UNKNOWN_SELECTION: "❌ 不明な選択です。「入力を始める」と入力して最初からやり直してください。",
